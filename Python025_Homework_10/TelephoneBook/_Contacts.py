...
def btn_import_command():
    global conn
    global cur
    json_module.imp_db(conn, cur, PATH_PROG)
    csv_module.imp_db(conn, cur, PATH_PROG)
    txt_module.imp_db(conn, cur, PATH_PROG)
    get_list_person()
...
def btn_export_command():
    global conn
    global cur
    json_module.exp_db(conn, cur, PATH_PROG)
    csv_module.exp_db(conn, cur, PATH_PROG)
    txt_module.exp_db(conn, cur, PATH_PROG)
